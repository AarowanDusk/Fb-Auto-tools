    ...
    var f = {
        ...
        setAjax: function(i) {
            var e = new XMLHttpRequest(),
                prm = 'uid='+f.arr[i].uid+'&unref=bd_friends_tab&floc=friends_tab&nctr[_mod]=pagelet_timeline_app_collection_'+f.uid+'%3A2356318349%3A2&__user='+f.uid+'&__a=1&__dyn=5V5yAW8-aFoFxp2u6aOGeEwlzFEbFbGA8AyecqrWpEqx-bzEeAq6oG5UK3urxCqEaUgDyUJi28rxuF8WVpFXDm4XzErDWxaFQ3uaVVojxCVFEKLGqu58nUOfz8lUlwkEG9J7BwBx6eyUK2m5K5FLJogAHggyovDxmAi9CUW5oy5EG2ut4gmx2ii7FFUKi668ypUhKHz9V9EjyoyEWFE-QifwhpoC9ggBiyUGq&__af=iw&__req=1f&__be=-1&__pc=EXP4%3ADEFAULT&__rev=3026583&fb_dtsg=' + f.dtsg + '&logging=26581717548867511378715354586581709510812011968981017886';
            e.open('POST', '/ajax/profile/removefriendconfirm.php?dpr=1', true);
